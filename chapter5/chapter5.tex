...
\textbf{Applications of Image Captioning and VQA} 
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{chapter5/Image_Captioning_and_VQA.png}
    \caption{Applications of Image Captioning and VQA}
...
\item \textbf{Generative Cross-Modal Retrieval}: Generative models are also pushing the boundaries of cross-modal retrieval by enabling systems to create new content from user queries. For example, DALL-E and similar models allow users to generate images based on detailed textual descriptions, while other systems are capable of generating music or video content from text-based prompts. This generative paradigm offers a new way of approaching content search and retrieval, where instead of finding existing content, users can generate what they need \cite{yin2023survey,vs2019muller}.
