...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{chapter8/Bias-Mitigation-Strategies.png}
    \caption{Bias Mitigation Strategies}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{chapter8/Privacy-Preserving_Techniques.png}
    \caption{Privacy-Preserving Techniques}
