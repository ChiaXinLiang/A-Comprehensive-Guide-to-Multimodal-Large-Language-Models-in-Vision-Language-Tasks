...
\textbf{Unified Representation:} MLLMs achieve integrated representations of multimodal data through unified codebooks and joint embedding spaces, enabling seamless processing across different modalities. This architectural approach offers several key capabilities:
...
\begin{tikzpicture}[scale=1, transform shape]
    ...
    % Image Captioning (2015-Present)
    \node[fill=blue!20, rounded corners, text width=3cm, align=center, above=1cm] at (2,0) {\textbf{Image Captioning}\\(2015-Present)};
    \node[fill=gray!10, text width=4.5cm, rounded corners, below=1.5cm] at (2,0) {\faCameraRetro\quad CNNs and RNNs allow models to ``describe" images};
    \draw[thick] (2, -0.3) -- (2, 0.3); % Year marker for 2015
    \node[below=0.7cm] at (2, 0) {2015};

    % Visual Question Answering
    \node[fill=green!20, rounded corners, text width=3cm, align=center, above=1cm] at (7,0) {\textbf{Visual Question Answering}};
    \node[fill=gray!10, text width=4.5cm, rounded corners, below=1.5cm] at (7,0) {\faQuestion\quad Models answer questions like ``What color is the car?"};
    \draw[thick] (7, -0.3) -- (7, 0.3); % Year marker for VQA period
    \node[below=0.7cm] at (7, 0) {2016 - 2018};

    % Vision-Language Transformers (2019-Present)
    \node[fill=orange!20, rounded corners, text width=3.5cm, align=center, above=1cm] at (12,0) {\textbf{Vision-Language Transformers}\\(2019-Present)};
    \node[fill=gray!10, text width=4.5cm, rounded corners, below=1.5cm] at (12,0) {\faRobot\quad Transformers enable multimodal tasks like text-to-image generation};
    \draw[thick] (12, -0.3) -- (12, 0.3); % Year marker for 2019
    \node[below=0.7cm] at (12, 0) {2019};
...
\textbf{Key Component of AI Theory} 
\begin{figure}
    \centering
    \includegraphics[width=0.6\linewidth]{chapter1/keycomponentofai.png}
    \caption{Key Component of AI Theory}
