...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{chapter6/DALLE.png}
    \caption{DALL-E 3}
    \label{fig:DALLE3}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{chapter6/Stable_diffusion.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{chapter6/imagen.png}
    \caption{Imagen 3}
    \label{fig:Imagen}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{chapter6/FLEX1.png}
    \caption{Flux.1 AI}
    \label{fig:FLEX}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{chapter6/copilot.png}
    \caption{Copilot}
    \label{fig:Copilot}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{chapter6/amazon.png}
    \caption{Amazon}
    \label{fig:Amazon}
\end{figure}
...
Synthesia, founded in 2017, is an AI video creation platform known for generating talking-head videos using AI avatars \cite{julia2019use}. 
...
Lumen5, an AI-powered video creation platform founded in 2016, is designed to help users turn text-based content into engaging videos \cite{volaric2024artificial}. 
...
Launched in 2021, Pictory is an AI video generation platform that converts text and images into high-quality videos \cite{cho2024sora}. 
...
DeepBrain AI \cite{churchill2018china}, founded in 2016, is an AI-driven video synthesis platform known for its AI avatars and video generation capabilities. 
...
D-ID \cite{garon2023practical}, founded in 2017, specializes in AI-powered video creation and facial animation. 
...
ModelScope \cite{wang2023modelscope}, a diffusion-based video generation model developed by Alibaba and released in 2023, is designed to create high-quality videos from textual inputs. 
...
Pika Labs \cite{guo2024comparative}, launched in 2023, is an AI video generation platform that also employs diffusion models to create video content. 
...
Released in September 2022 by OpenAI, Whisper \cite{graham2024evaluating} is an automatic speech recognition (ASR) system designed to provide highly accurate transcription of spoken language across multiple languages. 
...
ElevenLabs \cite{dewatri2023potential}, founded in 2022, is an AI platform specializing in voice generation and voice cloning, offering some of the most lifelike and customizable synthetic voices available today. 
...
Speechify \cite{chukwuemeka2024artificial}, founded in 2016, is a text-to-speech (TTS) platform that has become widely popular for turning written text into high-quality audio. 
...
Murf AI \cite{mohammadkarimi2024exploring}, founded in 2020, is an AI-powered voice generator and text-to-speech platform that has gained significant traction due to its high-quality voice synthesis and ease of use. 
...
RT-2 \cite{brohan2023rt}, or Robotic Transformer 2, is Google's latest vision-language-action model, published in July 2023. 
...
SayCan \cite{ahn2022can}, published in April 2022, is a method developed by Google to ground large language models in robotic affordances, essentially allowing robots to execute natural language instructions more effectively by understanding their physical capabilities. 
...
PaLM-SayCan builds on the SayCan methodology by integrating it with Google's PaLM (Pathways Language Model) to improve robotic planning and execution success rates \cite{ahn2022can}. 
...
ManipLLM, published in 2024 \cite{li2024manipllm}, is an embodied multimodal large language model designed specifically for object-centric robotic manipulation. 
...
Published in 2023, PaLM-E \cite{driess2023palm} is a groundbreaking language model that extends the capabilities of traditional language models by enabling them to directly output continuous robot actions. 
...
VoxPoser \cite{huang2023voxposer}, published in 2023, is a system that combines large language models with 3D scene understanding to enable robots to perform tasks involving robotic manipulation in complex environments. 
...
LLM-VLMap (Large Language Model Visual-Language Mapping), published in 2023 \cite{huang23vlmaps}, is a framework designed to enable robots to navigate and manipulate objects in their environment by using large language models for visual-language mapping. 
...
The integration of Multimodal Large Language Models (MLLMs) with DevOps \cite{ebert2016devops} and infrastructure platforms has become essential for facilitating the experimentation, development, and deployment of multimodal applications. 
...
Stack AI is a versatile platform that, while not exclusively focused on MLLMs, offers valuable support for multimodal models, including functionalities such as audio-to-text, text-to-audio, and text-to-image capabilities \cite{waleed2024efficient}. 
...
Ollama provides developers with a platform to run and experiment with MLLMs locally, enabling them to explore the potential of multimodal AI in various applications without relying on cloud-based infrastructure \cite{vik2024large}.
...
As one of the leading platforms for AI and machine learning, Hugging Face \cite{jain2022hugging} is highly relevant to MLLMs, offering a vast repository of multimodal models and providing a collaborative space for researchers and developers. 
...
Llama Stack \cite{wu2024llama}, developed by Meta, is directly related to the MLLM ecosystem, especially with the release of Llama 3.2, which includes multimodal models capable of visual understanding tasks. 
